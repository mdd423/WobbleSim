...
if __name__ == '__main__':
    ...
    parser.add_argument('-a',action='store',default=4,type=int)
    ...
    parser.add_argument('--gascellname',action='store',default='./data/gascell/keck_fts_inUse.idl',type=str)
    ...
    out = simulator.main(args.lr
                        ...
                        ,args.stellarname_wave,args.stellarname_flux
                        ,args.skycalcname,args.skycalcalma
                        ,args.gascellname,args.a)
